DROP DATABASE  IF EXISTS `springist_greeting`;

CREATE DATABASE  IF NOT EXISTS `springist_greeting`;
USE `springist_greeting`;
...
INSERT INTO greeting (message,postdate,user_id)
VALUES
